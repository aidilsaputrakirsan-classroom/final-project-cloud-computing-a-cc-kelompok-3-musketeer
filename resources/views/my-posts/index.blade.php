...
<head>
    ...
    <title>Postingan Saya | Chatter Box</title>
    <style>
        body {
            background: #f5f6fa;
...
<div class="main-container">
    ...
    <aside class="sidebar">
        ...
        <ul class="menu-list">
            ...
            <li class="active"><a href="{{ route('my-posts') }}"><i class="fa fa-file-alt"></i>Postingan Saya</a></li>
        ...
        <div class="profile-header">
            <div class="profile-info">
                ...
                <div style="margin-left: auto;">
                    <a href="{{ route('profile.edit') }}" style="padding: 8px 16px; background: #40A09C; color: #fff; border-radius: 7px; text-decoration: none; font-size: 0.9em; display: inline-block; transition: background 0.2s;" onmouseover="this.style.background='#278a84'" onmouseout="this.style.background='#40A09C'">
